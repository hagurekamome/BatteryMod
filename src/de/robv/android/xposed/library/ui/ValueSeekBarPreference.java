...
import com.hagurekamome.batterymod.R;
...
public class ValueSeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        tvValue = (TextView) newlayout.findViewById(R.id.valueseekbar_preference_value);
       	mCheckBox = (CheckBox)newlayout.findViewById(R.id.valueseekbar_preference_checkbox);
    ...
    protected void persistBothValues() {
    	if (shouldPersist()) {
            ...
            if (mShowCheckbox)
            	editor.putBoolean(getKey() + "_enabled", mChecked);
            if (shouldCommit()) {
                try {
                    editor.apply();
    ...
    protected void onBindView(View view) {
        ...
        mseekBar = (SeekBar) view.findViewById(R.id.valueseekbar_preference_seekbar);
        mseekBar.setOnSeekBarChangeListener(this);
        mseekBar.setMax((mMax - mMin) / mStep);
        mseekBar.setProgress((mProgress - mMin) / mStep);
        tvValue.setText(String.format(valueDisplayFormat, mProgress));
    	mCheckBox.setChecked(mChecked);
        if(mShowCheckbox){
        	mseekBar.setEnabled(mCheckBox.isChecked());
        }else
    ...
    protected void onSetInitialValue(boolean restoreValue, Object defaultValue) {
        ...
        mChecked = !mShowCheckbox || getSharedPreferences().getBoolean(getKey() + "_enabled", false);  
    }
